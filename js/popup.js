...
canvas.addEventListener('click',
                        ...
                        {
                          volume =
                              calculateVolume(event.clientX, event.clientY);
                          drawVolume(volume);
 ...
 * -----------------------------------------------------------------------------
 */
function sendState(state) { onClick(state); }
...
function drawVolume(volume) {
  ...
  context.arc // draw volume
      (center[0], center[1], radius,
       ...
       Math.PI * (2 * (volume)), false);

  var rad = context.createRadialGradient(center[0], center[1], radius - 5,
